...
function ChatInput({handleChat}) {
  ...
  return (
    <div>
    <div className='px-3'>{ShowPicker && <EmojiPicker  onEmojiClick={handleEmojiClick} emojiStyle='google' theme='dark' skinTonesDisabled='true' width="15rem" height='20rem'/>}</div>
    <div className='md:p-5 py-3 px-2 flex md:gap-10 gap-2 w-full items-center'>
        ...
        <form className='flex justify-between md:gap-10 gap-2 w-full items-center' onSubmit={(e) => sendMsg(e)}>
